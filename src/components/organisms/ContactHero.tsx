...
export function ContactHero({ className }: ContactHeroProps) {
  return (
    <section className={cn("relative overflow-hidden bg-gradient-to-br from-background via-background to-powder-pink/20 pt-16", className)}>
      ...
      <div className="absolute right-0 top-0 -translate-y-1/2 translate-x-1/2 w-[600px] h-[600px] bg-gradient-to-l from-primary/20 to-warning-gold/20 rounded-full blur-3xl" />
